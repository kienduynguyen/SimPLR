...
def maybe_enable_profiling(
    ...
    if enable_profiling:
        ...
        save_trace_dir = save_traces_folder
...
def maybe_enable_memory_snapshot(
    ...
    enable_snapshot = enable_memory_snapshot
    if enable_snapshot:
        snapshot_folder = save_memory_snapshot_folder
        snapshot_dir = os.path.join(dump_folder, snapshot_folder)
